      ...
      <section className="mt-12 sm:mt-20">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-14 lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-[52ch] font-body text-sm lg:text-base leading-relaxed text-[#E7EAEC]">
              Du brauchst kein technisches Vorwissen. Wer eine Route kennt und
              sich Rätsel ausdenken kann, baut in einer halben Stunde eine Quest.
            </p>
          </div>
          <ul className="flex flex-wrap gap-2 lg:gap-3">
            {OCCASIONS.map((occasion) => (
              <li
                key={occasion}
                className="rounded-badge border border-border bg-gq-dark-teal px-4 py-3 text-tech text-[10px] lg:text-[11px] tracking-[0.1em] text-gq-grey"
              >
                {occasion}
              </li>
            ))}
